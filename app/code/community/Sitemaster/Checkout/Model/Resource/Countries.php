...
class Sitemaster_Checkout_Model_Resource_Countries extends Mage_Directory_Model_Mysql4_Country_Collection
{
    protected
        /**
     ...
     *
     * @return Sitemaster_Checkout_Model_Resource_Countries
     */
    ...
    public function getCountryCodeByName($countryName)
    {
        ...
        if (isset($countries[$countryName])) {
            ...
            return Mage::helper('sitemaster_checkout')->getDefaultCountryId();
        }
    }
    ...
    {
        return Mage::helper('sitemaster_checkout')->lowerCase($string);
    }
}
