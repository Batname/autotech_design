...
class Sitemaster_Checkout_Helper_Data extends Mage_Core_Helper_Abstract
{
    /**
     * Xml configuration pathes
     */
    const XML_PATH_DEFAULT_SHIPPING_METHOD = 'checkout/sitemaster/default_shipping_method';
    const XML_PATH_DEFAULT_PAYMENT_METHOD  = 'checkout/sitemaster/default_payment_method';
    const XML_PATH_DEFAULT_COUNTRY = 'checkout/sitemaster/default_country';
    const XML_PATH_DEFAULT_REGION  = 'checkout/sitemaster/default_region';
    const XML_PATH_DEFAULT_CITY    = 'checkout/sitemaster/default_city';
    const XML_PATH_ALLOW_GUEST_CO  = 'checkout/sitemaster/allow_guest_checkout';
    const XML_PATH_USE_DEFAULT_COUNTRY = 'checkout/sitemaster/use_default_country';
    const XML_PATH_PASSWORD_FIELD_TYPE = 'checkout/sitemaster/password_type';
    const XML_PATH_LOCATION_FIELD_TYPE = 'checkout/sitemaster/location_type';
    const XML_PATH_SHOW_BUILD_FIELDS   = 'checkout/sitemaster/show_build_fields';
    const XML_PATH_MAY_SUBSCRIBE_GUEST ='newsletter/subscription/allow_guest_subscribe';
    const XML_PATH_SHOW_NEWSLETTER     = 'checkout/sitemaster/show_newsletter';
    const XML_PATH_NEWSLETTER_SEND_SUCCESS_EMAIL = 'checkout/sitemaster/newsletter_send_success';
    const XML_PATH_NEWSLETTER_SEND_REQUEST_EMAIL = 'checkout/sitemaster/newsletter_send_request';
    const XML_PATH_PAYMENT_DEPENDENT_SECTIONS  = 'checkout/sitemaster/payment_dependent_sections';
    const XML_PATH_SHIPPING_DEPENDENT_SECTIONS = 'checkout/sitemaster/shipping_dependent_sections';  //easyco
    ...
    {
        return $this->getPasswordType() == Sitemaster_Checkout_Model_Source::PASSWORD_FIELD;
    }
    ...
    {
        return $this->getPasswordType() == Sitemaster_Checkout_Model_Source::PASSWORD_PHONE;
    }
    ...
    {
        return $this->getPasswordType() == Sitemaster_Checkout_Model_Source::PASSWORD_GENERATE;
    }
    ...
    {
        return $this->getLocationType() == Sitemaster_Checkout_Model_Source::LOCATION_ONE;
    }
    ...
    {
        return $this->getNewsletterType() != Sitemaster_Checkout_Model_Source::CHECKBOX_UNVISIBLE;
    }
    ...
    {
        return $this->getNewsletterType() == Sitemaster_Checkout_Model_Source::CHECKBOX_CHECKED;
    }
    ...
    {
        $earth  = Mage::getResourceModel('sitemaster_checkout/countries');
        $data   = array(
            'country_id' => null,
            'region'     => null,
            'region_id'  => null,
    ...
    {
        $session = Mage::getSingleton('customer/session');
        $order   = Mage::getModel('sitemaster_checkout/order')->setSession($session);
    ...
    public function getUpdateUrl() {
      return $this->_getUrl('sitemaster_order/checkout/update', array('_secure' => true));
    }

    public function getPlaceUrl() {
      return $this->_getUrl('sitemaster_order/checkout/place', array('_secure' => true));
    }
}
