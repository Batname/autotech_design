...
* */
class Ext4mage_Orders2csv_Model_Status extends Varien_Object
{
	...
	{
		return array(
		self::STATUS_ENABLED    => Mage::helper('orders2csv')->__('Enabled'),
		self::STATUS_DISABLED   => Mage::helper('orders2csv')->__('Disabled')
		);
	}
}