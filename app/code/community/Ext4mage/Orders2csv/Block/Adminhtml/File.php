...
* */
class Ext4mage_Orders2csv_Block_Adminhtml_File extends Mage_Adminhtml_Block_Widget_Grid_Container
{
	public function __construct()
	{
		$this->_controller = 'adminhtml_file';
		$this->_blockGroup = 'orders2csv';
		$this->_headerText = Mage::helper('orders2csv')->__('Orders2csv file structure');
		$this->_addButtonLabel = Mage::helper('orders2csv')->__('Create new file structure');
		parent::__construct();
	}
}