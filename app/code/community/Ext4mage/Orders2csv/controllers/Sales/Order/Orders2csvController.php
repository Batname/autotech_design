 ...
 * */
class Ext4mage_Orders2csv_Sales_Order_Orders2csvController extends Mage_Adminhtml_Controller_Action
{
    /**
    ...
    public function makecsvAction()
    {
		...
		$file = Mage::getModel('orders2csv/orders2csv')->saveOrdersAsCsv($orders);
