 ...
 */?>
<?php
class AW_Advancedreports_UsersController extends Mage_Adminhtml_Controller_Action
{
    ...
    public function exportOrderedCsvAction()
    {
        ...
        $content    = $this->getLayout()->createBlock('advancedreports/advanced_users_grid')
            ->getCsv();
