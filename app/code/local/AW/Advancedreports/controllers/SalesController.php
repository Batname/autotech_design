 ...
 */?>
<?php
class AW_Advancedreports_SalesController extends Mage_Adminhtml_Controller_Action
{
    ...
    public function exportOrderedCsvAction()
    {
        ...
        $content    = $this->getLayout()->createBlock('advancedreports/advanced_sales_grid')
            ->getCsv();
