 ...
 */?>
<?php
class AW_Advancedreports_PurchasedController extends Mage_Adminhtml_Controller_Action
{
    ...
    public function exportOrderedCsvAction()
    {
        ...
        $content    = $this->getLayout()->createBlock('advancedreports/advanced_purchased_grid')
            ->getCsv();
