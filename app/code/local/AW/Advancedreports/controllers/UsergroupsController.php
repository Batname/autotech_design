 ...
 */?>
<?php
class AW_Advancedreports_UsergroupsController extends Mage_Adminhtml_Controller_Action
{
    ...
    public function exportOrderedCsvAction()
    {
        ...
        $content    = $this->getLayout()->createBlock('advancedreports/advanced_usergroups_grid')
            ->getCsv();
