...
class Hardik_Ajaxcart_Checkout_CartController extends Mage_Checkout_CartController {
    ...
    public function addAction() {
        ...
        try {
            ...
            $back_link = "<br><br><a class='clouse-me hardik-button'>".Mage::helper('checkout')->__('Continue shopping')."</a><br style='margin-bottom: 5px;'>";
            ...
            foreach ($messages as $message) {
                $json_messages[] = Mage::helper('core')->escapeHtml($message) . $back_link . $javascript;
            }
    ...
    public function deleteAction() {
        ...
        $back_link = "<br><br><a class='clouse-me hardik-button'>".Mage::helper('checkout')->__('Continue shopping')."</a>";
        $javascript = "<script>jQuery( \".clouse-me\" ).click(function() {
            jQuery( \".Growler-notice\" ).fadeOut(\"slow\");
            });
            </script>";

        $_response->setMessage($this->__('Item was removed.').$back_link. $javascript);
